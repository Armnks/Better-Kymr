  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to(".fc-dot", { scale: 0.2, autoAlpha: 0, duration: 0.4, ease: "power2.in" })
        ...
        .to(".fc-strategy", { x: "-34vw", y: "-30vh", scale: 0.16, scaleX: 1, rotation: 0, autoAlpha: 0.35, duration: 0.7, ease: "power3.inOut" }, "+=0.2")
        .to(".fc-creative", { x: "32vw", y: "30vh", scale: 0.16, autoAlpha: 0.35, duration: 0.7, ease: "power3.inOut" }, "<")
        .to(".fc-production", { y: "-2vh", scale: 1.05, duration: 0.7, ease: "power3.inOut" }, "<")
        .to([".fc-strategy", ".fc-creative"], { autoAlpha: 0, duration: 0.5, ease: "power2.in" }, "+=0.15")
